...
import kozminykh.task2.page.object.GoogleSearchResult;
...
public class Tests extends TestFrame {
    ...
    void isWikiLinkThere() {
        GoogleSearchResult searchResult = new GoogleSearchResult(driver, "Гладиолус");
    ...
    void buyingRateIsLess() {
        GoogleSearchResult searchResult = new GoogleSearchResult(driver, "Открытие");
